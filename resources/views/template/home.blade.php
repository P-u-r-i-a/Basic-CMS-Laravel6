    ...
    <div id="all">
      ...
      <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
          <div class="container"><a href="index.html" class="navbar-brand home"><img src="{{ asset('universal/img/logo.png') }}" alt="Universal logo" class="d-none d-md-inline-block"><img src="{{ asset('universal/img/logo-small.png') }}" alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">Universal - go to homepage</span></a>
              ...
              <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Features<b class="caret"></b></a>
                  <ul class="dropdown-menu megamenu">
                    <li>
                      <div class="row">
                        <div class="col-lg-6"><img src="{{ asset('universal/img/template-easy-customize.png') }}" alt="" class="img-fluid d-none d-lg-block"></div>
                ...
                <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Portfolio <b class="caret"></b></a>
                  <ul class="dropdown-menu megamenu">
                    <li>
                      <div class="row">
                        <div class="col-lg-6"><img src="{{ asset('universal/img/template-homepage.png') }}" alt="" class="img-fluid d-none d-lg-block"></div>
                        <div class="col-lg-3 col-md-6">
                          <h5>Portfolio</h5>
                          <ul class="list-unstyled mb-3">
      ...
      <section style="background: url('{{ asset('universal/img/photogrid.jpg') }} center center repeat; background-size: cover;" class="bar background-white relative-positioned">
        <div class="container">
          <!-- Carousel Start-->
              ...
              <div class="homepage owl-carousel">
                <div class="item">
                  <div class="row">
                    <div class="col-md-5 text-right">
                      <p><img src="{{ asset('universal/img/logo.png') }}" alt="" class="ml-auto"></p>
                      <h1>Multipurpose responsive theme</h1>
                      <p>Business. Corporate. Agency.<br>Portfolio. Blog. E-commerce.</p>
                    </div>
                    <div class="col-md-7"><img src="{{ asset('universal/img/template-homepage.png') }}" alt="" class="img-fluid"></div>
                  </div>
                </div>
                <div class="item">
                  <div class="row">
                    <div class="col-md-7 text-center"><img src="{{ asset('universal/img/template-mac.png') }}" alt="" class="img-fluid"></div>
                    <div class="col-md-5">
                ...
                <div class="item">
                  <div class="row">
                    ...
                    <div class="col-md-7"><img src="{{ asset('universal/img/template-easy-customize.png') }}" alt="" class="img-fluid"></div>
                  </div>
                </div>
                <div class="item">
                  <div class="row">
                    <div class="col-md-7"><img src="{{ asset('universal/img/template-easy-code.png') }}" alt="" class="img-fluid"></div>
                    <div class="col-md-5">
      ...
      <section class="bar bg-gray">
        <div class="container">
          ...
          <ul class="list-unstyled owl-carousel customers no-mb">
            <li class="item"><img src="{{ asset('universal/asset/img/customer-1.png') }}" alt="" class="img-fluid"></li>
            <li class="item"><img src="{{ asset('universal/asset/img/customer-2.png') }}" alt="" class="img-fluid"></li>
            <li class="item"><img src="{{ asset('universal/asset/img/customer-3.png') }}" alt="" class="img-fluid"></li>
            <li class="item"><img src="{{ asset('universal/asset/img/customer-4.png') }}" alt="" class="img-fluid"></li>
            <li class="item"><img src="{{ asset('universal/asset/img/customer-5.png') }}" alt="" class="img-fluid"></li>
            <li class="item"><img src="{{ asset('universal/asset/img/customer-6.png') }}" alt="" class="img-fluid"></li>
          </ul>
        </div>
      </section>
      <!-- GET IT-->
          ...
          <div class="row">
            ...
            <div class="col-lg-3">
              ...
              <ul class="list-unstyled footer-blog-list">
                <li class="d-flex align-items-center">
                  <div class="image"><img src="{{ asset('universal/img/detailsquare.jpg') }}" alt="..." class="img-fluid"></div>
                  <div class="text">
            ...
            <div class="col-lg-3">
              <ul class="list-inline photo-stream">
                <li class="list-inline-item"><a href="#"><img src="{{ asset('universal/img/detailsquare.jpg') }}" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="{{ asset('universal/img/detailsquare2.jpg') }}" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="{{ asset('universal/img/detailsquare3.jpg') }}" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="{{ asset('universal/img/detailsquare3.jpg') }}" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="{{ asset('universal/img/detailsquare2.jpg') }}" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="{{ asset('universal/img/detailsquare.jpg') }}" alt="..." class="img-fluid"></a></li>
              </ul>
